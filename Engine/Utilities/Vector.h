...
namespace primal::utl {
	...
	public:
		...
		// Copy- or move-constraints an item at the end of the vector
		...
		// Same as erase() but faster becase it just copies the last item
		...
		// Pointer to start of data. Might be Null

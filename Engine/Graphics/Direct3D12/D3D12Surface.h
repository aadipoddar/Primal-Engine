...
namespace primal::graphics::d3d12 {
	...
	public:
		...
		constexpr d3d12_surface(d3d12_surface&& o)
			:_swap_chain{ o._swap_chain }, _window{ o._window }, _cuurent_bb_index{ o._cuurent_bb_index }
		...
		constexpr ID3D12Resource* const back_buffer() const { return _render_target_data[_cuurent_bb_index].resource; }
		constexpr D3D12_CPU_DESCRIPTOR_HANDLE rtv() const { return _render_target_data[_cuurent_bb_index].rtv.cpu; }
	...
	private:
		...
		constexpr void move(d3d12_surface& o)
		{
			...
			_window = o._window;
			_cuurent_bb_index = o._cuurent_bb_index;
		...
		mutable u32			_cuurent_bb_index{ 0 };
